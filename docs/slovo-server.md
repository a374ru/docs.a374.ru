...
<p><a href="#локальный-запуск-сервера-nodejs">Запуск локального сервера `NODEJS`</a></p>
<p><a href="#локальный-запуск-сервера-python">Запуск локального сервера `python`</a></p>
