...
<span style="color: #8F7161; background-color: #faa2; padding:2px">Ваш файл стал выполняемым. Теперь чтобы запустить сервер просто кликните по файлу. Файл не должен иметь расширения `sh`.
